...
Data Merging: Combined transaction and customer data to create a unified dataset for segment-based analysis.

Metrics Calculation: Analyzed total sales, number of customers, and average transactions per customer across different segments (e.g., "Mainstream Young Singles/Couples").

Market Basket Analysis: Used the Apriori algorithm and association rules to find product affinities within specific customer segments.
...
Insights & Findings
Top Segment: "Mainstream Young Singles/Couples" and "Mainstream Midage Singles/Couples" are significant contributors to sales.

Brand Preference: Kettle chips are consistently popular across most segments.
